...
const VOCAB_QUIZ_DATA = [
    ...
    // New 38 Items
    { sentence: "The company imposed a heavy _______ for the contract violation.", word: "penalty", answer: "O", explanation: "[원칙 (1) 문맥] 계약 위반에 대해 무거운 '벌금/위약금'을 부과했다는 의미가 문맥상 적절합니다." },
    { sentence: "She made a _______ remark during the meeting regarding the delay.", word: "pointed", answer: "O", explanation: "[원칙 (1) 문맥] 지연에 관해 '날카로운/예리한' 지적을 했다는 의미입니다." },
    { sentence: "We must adhere to the _______ of fairness in hiring.", word: "principle", answer: "O", explanation: "[원칙 (1) 문맥] 채용에서의 공정성 '원칙'을 고수해야 한다는 의미입니다." },
    { sentence: "The government plans to _______ the use of plastic bags.", word: "regulate", answer: "O", explanation: "[원칙 (1) 문맥] 비닐봉지 사용을 '규제하다/조절하다'는 동사가 필요합니다." },
    { sentence: "The police tried to _______ the protest quickly.", word: "suppress", answer: "O", explanation: "[원칙 (1) 문맥] 시위를 '억누르다/진압하다'는 의미가 자연스럽습니다." },
    { sentence: "The audience waited _______ for the winner to be announced.", word: "tensely", answer: "O", explanation: "[원칙 (1) 문맥] 우승자 발표를 '긴장하여/숨죽이며' 기다렸다는 부사가 적절합니다." },
    { sentence: "There are no changes _______ the new policy.", word: "with respect to", answer: "O", explanation: "[원칙 (3) 콜로케이션] '~~에 관하여'라는 숙어 표현입니다 (regarding/concerning)." },
    { sentence: "Employees _______ take a break every two hours.", word: "be allowed to do", answer: "O", explanation: "[원칙 (2) 문법] 'be allowed to + 동사원형': ~하도록 허락받다는 수동태 구문입니다." },
    { sentence: "We can solve this _______ compromise.", word: "by way of", answer: "O", explanation: "[원칙 (3) 콜로케이션] '~~의 방법으로/~~을 통해서'라는 관용구입니다." },
    { sentence: "The new rules apply _______.", word: "from this day onward", answer: "O", explanation: "[원칙 (3) 콜로케이션] '오늘부터 계속/앞으로'라는 시간 표현입니다." },
    { sentence: "There is a deep _______ between the two parties.", word: "distrust", answer: "O", explanation: "[원칙 (1) 문맥] 두 당사자 간의 깊은 '불신'이 있다는 문맥입니다." },
    { sentence: "The _______ committee will handle the complaints.", word: "newly established", answer: "O", explanation: "[원칙 (1) 문맥] '신설된' 위원회가 불만을 처리할 것이라는 의미입니다." },
    { sentence: "The law will be _______ next month.", word: "put into effect", answer: "O", explanation: "[원칙 (3) 콜로케이션] 법이 '시행되다/효력을 발생하다'는 표현입니다." },
    { sentence: "Please print your _______ before arriving.", word: "registration confirmation", answer: "O", explanation: "[원칙 (1) 문맥] 도착 전에 '등록 확인서'를 출력하라는 의미입니다." },
    { sentence: "Promotions are given _______ age or gender.", word: "without respect to", answer: "O", explanation: "[원칙 (3) 콜로케이션] 나이나 성별을 '고려하지 않고/무시하고'라는 의미입니다." },
    { sentence: "Lab workers must wear a _______ at all times.", word: "protective smock", answer: "O", explanation: "[원칙 (1) 문맥] 실험실에서는 '보호 작업복'을 착용해야 한다는 안전 수칙 문맥입니다." },
    { sentence: "His _______ was crucial to the case.", word: "testimony", answer: "O", explanation: "[원칙 (1) 문맥] 사건에 있어 그의 '증언'이 결정적이었다는 의미입니다." },
    { sentence: "We acted in _______ with the regulations.", word: "accordance", answer: "O", explanation: "[원칙 (3) 콜로케이션] 'in accordance with': 규정과 '일치하여/따라서'라는 숙어입니다." },
    { sentence: "The office is closed _______ the national holiday.", word: "in observance of", answer: "O", explanation: "[원칙 (3) 콜로케이션] 국경일을 '기념하여/준수하여' 휴무한다는 표현입니다." },
    { sentence: "I _______ deleted the file.", word: "inadvertently", answer: "O", explanation: "[원칙 (1) 문맥] 고의가 아니라 '무심코/실수로' 파일을 삭제했다는 의미입니다." },
    { sentence: "The _______ system is being reformed.", word: "judicial", answer: "O", explanation: "[원칙 (1) 문맥] '사법' 제도가 개혁되고 있다는 시사적인 문맥입니다." },
    { sentence: "We are _______ aware of the competition.", word: "keenly", answer: "O", explanation: "[원칙 (3) 콜로케이션] 경쟁을 '날카롭게/뼈저리게' 인식하고 있다는 강조 부사입니다." },
    { sentence: "They filed a _______ against the company.", word: "lawsuit", answer: "O", explanation: "[원칙 (3) 콜로케이션] 회사에 대해 '소송'을 제기하다(file a lawsuit)는 표현입니다." },
    { sentence: "He handles the _______ tasks of the office.", word: "mundane", answer: "O", explanation: "[원칙 (1) 문맥] 사무실의 '일상적인/허드렛일의' 업무를 처리한다는 의미입니다." },
    { sentence: "This area is _______ to unauthorized personnel.", word: "off-limits", answer: "O", explanation: "[원칙 (1) 문맥] 허가받지 않은 인원에게 '출입 금지'된 구역이라는 의미입니다." },
    { sentence: "The city passed a new noise _______.", word: "ordinance", answer: "O", explanation: "[원칙 (1) 문맥] 도시가 새로운 소음 '조례'를 통과시켰다는 법률 관련 문맥입니다." },
    { sentence: "The defective products were _______ from the shelves.", word: "pulled", answer: "O", explanation: "[원칙 (1) 문맥] 결함 제품이 진열대에서 '철수된/회수된' 상황입니다." },
    { sentence: "The manager had to _______ the employee for lateness.", word: "reprimand", answer: "O", explanation: "[원칙 (1) 문맥] 지각 때문에 직원을 '질책하다'는 의미가 적절합니다." },
    { sentence: "The board passed a _______ to cut costs.", word: "resolution", answer: "O", explanation: "[원칙 (1) 문맥] 이사회가 비용 절감 '결의안'을 통과시켰다는 의미입니다." },
    { sentence: "Competition in the market is _______.", word: "stiff", answer: "O", explanation: "[원칙 (3) 콜로케이션] 시장 경쟁이 '치열한/심한'을 뜻할 때 stiff competition이라고 합니다." },
    { sentence: "You need evidence to _______ your allegations.", word: "substantiate", answer: "O", explanation: "[원칙 (1) 문맥] 혐의를 '입증하다/구체화하다'는 논리적인 단어입니다." },
    { sentence: "Do not _______ on private property.", word: "trespass", answer: "O", explanation: "[원칙 (1) 문맥] 사유지에 '무단 침입하다'는 법률적/일반적 경고입니다." },
    { sentence: "Bonuses are awarded _______ of the CEO.", word: "at the discretion", answer: "O", explanation: "[원칙 (3) 콜로케이션] CEO의 '재량으로' 보너스가 지급된다는 관용구입니다." },
    { sentence: "The rules _______ the powers of the committee.", word: "circumscribe", answer: "O", explanation: "[원칙 (1) 문맥] 규칙이 위원회의 권한을 '제한하다/한계를 정하다'는 의미입니다." },
